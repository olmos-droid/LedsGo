...
public class LogIn extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_log_in);
            ...
            Users user=leerValor(getApplicationContext());
                ...
                if (!(stringEmail.isEmpty() || stringPassword.isEmpty())) {
                    if (validuser == true &&stringPassword.length()>4) {
                        ...
                        if (ComprobarEmail(stringEmail, stringPassword)) {
                            ...
                            Toast.makeText(LogIn.this, "Email o Pass incorrect", Toast.LENGTH_SHORT).show();
                        }
        ...
        textViewForgotPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!(editTextEmail.getText().toString().isEmpty())) {
                    ...
                    System.out.println(arraylistID.get(pos)+"  "+arraylistUser.get(pos).getEmail()+" sd a"+arraylistUser.get(pos).getName()+"sad"+arraylistUser.get(pos).getCountry()+"sad"+arraylistUser.get(pos).getPassword());
                    startActivity(intent);
                }else {
                    Toast.makeText(LogIn.this, "Introdueix el email siusplau", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    public  Users leerValor(Context context) {
